...
-- Description:	Return allow in json format when user get an team
-- InPut:		@Id = Role.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
Create PROCEDURE [dbo].[ImsProcRoleAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
