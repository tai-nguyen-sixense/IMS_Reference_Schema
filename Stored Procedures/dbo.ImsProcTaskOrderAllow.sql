...
-- Description:	Return allow in json format when user get an taskOrder
-- InPut:		@Id = TaskOrder.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcTaskOrderAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
