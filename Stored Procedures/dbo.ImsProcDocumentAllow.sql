...
-- Description:	Return allow in json format when user get an document
-- InPut:		@Id = Document.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcDocumentAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
