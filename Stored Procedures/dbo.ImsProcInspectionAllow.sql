...
-- Description:	Return allow in json format when user get an inspection
-- InPut:		@Id = Inspection.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcInspectionAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
