...
-- Description:	Return Survey in json format when user creates a new Survey
...
CREATE PROCEDURE [dbo].[ImsProcSurveyNew] @Id uniqueidentifier,@SurveyJson nvarchar(max), @UserId uniqueidentifier
