...
-- Description:	Return allow in json format when user get an master
-- InPut:		@Id = Master.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcMasterAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
