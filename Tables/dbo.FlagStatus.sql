...
[IsReadOnly] [bit] NOT NULL CONSTRAINT [DF_FlagStatus_IsReadOnly] DEFAULT ((0)),
[StatusChangeWarningMessage] [nvarchar] (4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[IsRetired] [bit] NOT NULL CONSTRAINT [DF_FlagStatus_IsRetired] DEFAULT ((0))
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[FlagStatus] ADD CONSTRAINT [PK_FlagStatus] PRIMARY KEY NONCLUSTERED ([Id]) ON [PRIMARY]
GO
