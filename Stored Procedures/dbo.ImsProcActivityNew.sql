...
-- Description:	Return activity in json format when user creates a new activity
...
CREATE PROCEDURE [dbo].[ImsProcActivityNew] @Id uniqueidentifier,@activityJson nvarchar(max), @UserId uniqueidentifier
...
BEGIN
	...
	BEGIN TRY  
		...
		--    - or using simple replace
					-- set @returnActivityJson=replace(@activityJson,'"number":null','"number":"default number for activity"');
		--    - or rewrite the activity object
					-- set @returnActivityJson='{"attributeValues":null,"asset":{"knwlType":{"id":"7165a2a0-c0d3-4153-a0fd-74ab98301b79","name":"Bridge","color":"#3EBCBD","icon":"bridge","attributeFields":[]},"comments":"Soprema Soprajoints failed and are leaking.","imageUrl":null,"id":"2f20f775-42ec-4df7-b253-a56621965212","name":"WEST STREET UNDERPASS","number":" 1 -  43/"},"routings":null,"photos":null,"latitude":null,"longitude":null,"allow":{"actOn":true,"edit":true,"delete":true,"copy":true,"check":true,"lockedFields":[]},"taskParent":null,"assetComponentId":null,"inspectionSheetId":null,"attributeFieldId":null,"description":null,"comments":null,"knwlStatu":{"id":"c12d109c-c7de-4466-bcd5-06ee25c7b65d","name":"Xxx","color":"#0F0F9B","icon":"activity","position":1},"knwlPriority":{"id":"7b83d55e-6b36-474e-bc56-55edd934b82a","name":"Xxx","color":"#0F0F9B","icon":"flag"},"date":"2017-11-17T19:05:07.0683121+01:00","imageUrl":null,"assetComponent":null,"attributeValue":null,"id":"9146550e-89c1-4b61-aba9-aa5db2e84d28","route":"activity","number":null,"knwlType":{"id":"dc5a4663-2759-4b35-8306-e05d66acc1f0","name":"Xxx","color":"#0F0F9B","icon":"activity","attributeFields":[]}}';
