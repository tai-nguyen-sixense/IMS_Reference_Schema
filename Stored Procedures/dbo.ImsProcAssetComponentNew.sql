...
-- Description:	Return assetComponent in json format when user creates a new assetComponent
...
CREATE PROCEDURE [dbo].[ImsProcAssetComponentNew] @Id uniqueidentifier,@assetComponentJson nvarchar(max), @UserId uniqueidentifier
...
BEGIN
	...
	BEGIN TRY  
		...
		--    - or using simple replace
					-- set @returnAssetComponentJson=replace(@assetComponentJson,'"name":null','"name":"default name for assetComponent"');
		--    - or rewrite the assetComponent object
					-- set @returnAssetComponentJson='{"latitude":null,"longitude":null,"polyline":null,"attributeValues":null,"allow":{"actOn":true,"edit":true,"delete":true,"copy":true,"check":true,"lockedFields":[]},"position":1,"knwlType":{"id":"b9f5a749-c95a-417c-8424-fd2cdf335823","name":"Decks","color":"#D1B9B9","icon":"flag","attributeFields":null},"comments":null,"asset":{"knwlType":{"id":"7165a2a0-c0d3-4153-a0fd-74ab98301b79","name":"Bridge","color":"#3EBCBD","icon":"bridge","attributeFields":[]},"comments":"totot","imageUrl":null,"id":"131a9293-1b83-4324-86e8-342da8da4d64","name":"NORTH PARK STEET UNDERPASS","number":" 1 -  44/"},"assetComponent":null,"id":"70697d65-b5db-4f73-851e-fd933d27684c","name":null,"number":null,"fullName":null,"fullPath":null}';
