...
-- Description:	Return allow in json format when user get an asset
-- InPut:		@Id = Asset.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcAssetAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
