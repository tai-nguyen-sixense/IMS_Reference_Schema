...
-- Description:	Return inspection in json format when user creates a new inspection
...
CREATE PROCEDURE [dbo].[ImsProcInspectionNew] @Id uniqueidentifier,@inspectionJson nvarchar(max), @UserId uniqueidentifier
...
BEGIN
	...
	BEGIN TRY  
		...
		--    - or using simple replace
					-- set @returnInspectionJson=replace(@inspectionJson,'"number":null','"number":"default number for inspection"');
		--    - or rewrite the inspection object
					-- set @returnInspectionJson='{"attributeValues":null,"asset":{"knwlType":{"id":"7165a2a0-c0d3-4153-a0fd-74ab98301b79","name":"Bridge","color":"#3EBCBD","icon":"bridge","attributeFields":[]},"comments":"toto","imageUrl":null,"id":"4b933481-2149-471b-b2c9-df955504644d","name":"GURNEY CREEK WHITEMAN BRIDGE","number":" 1 -  85/"},"routings":null,"photos":null,"latitude":null,"longitude":null,"allow":{"actOn":true,"edit":true,"delete":true,"copy":true,"check":true,"lockedFields":["number"]},"taskParent":null,"assetComponentId":null,"inspectionSheetId":null,"attributeFieldId":null,"description":null,"comments":null,"knwlStatu":{"id":"236bc2a6-78c0-47e0-b4f0-85c3308d4b22","name":"Open","color":"#0F0F9B","icon":"inspection","position":1},"knwlPriority":null,"date":"2017-11-17T18:51:53.7505489+01:00","imageUrl":null,"assetComponent":null,"attributeValue":null,"id":"05e26a44-aab8-4dcb-8a02-74d108a1b0cf","route":"inspection","number":null,"knwlType":{"id":"a9c2b7dd-094a-468a-a6b4-6a6e2c2a18ac","name":"Regular OSIM","color":"#38E4DB","icon":"inspection","attributeFields":[]}}';
