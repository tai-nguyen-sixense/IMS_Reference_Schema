...
-- Description:	Return allow in json format when user get a flag
-- InPut:		@Id = Flag.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcFlagAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
