...
-- Description:	Return allow in json format when user get an taskPhoto
-- InPut:		@Id = TaskPhoto.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcTaskPhotoAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
