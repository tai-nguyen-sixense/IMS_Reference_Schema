...
-- InPut:		@Id = role.Id, @roleJson= default role in json format, @UserId = Loggged User Id
...
Create PROCEDURE [dbo].[ImsProcRoleSaveBefore] @Id uniqueidentifier, @roleJson nvarchar(max), @UserId uniqueidentifier
