...
-- Description:	Return allow in json format when user get an defect
-- InPut:		@Id = Defect.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcDefectAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
