...
-- Description:	Return allow in json format when user get an user
-- InPut:		@Id = User.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcUserAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
