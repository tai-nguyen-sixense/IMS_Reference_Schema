...
-- InPut:		@Id = Team.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcTeamAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
