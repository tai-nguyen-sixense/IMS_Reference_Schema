...
-- Description:	Return allow in json format when user get an contact
-- InPut:		@Id = Contact.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcContactAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
