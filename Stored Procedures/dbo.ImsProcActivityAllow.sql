...
-- Description:	Return allow in json format when user get an activity
-- InPut:		@Id = Activity.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcActivityAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
