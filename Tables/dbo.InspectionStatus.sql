...
[IsReadOnly] [bit] NOT NULL CONSTRAINT [DF_InspectionStatus_IsReadOnly] DEFAULT ((0)),
[StatusChangeWarningMessage] [nvarchar] (4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[IsRetired] [bit] NOT NULL CONSTRAINT [DF_InspectionStatus_IsRetired] DEFAULT ((0))
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[InspectionStatus] ADD CONSTRAINT [PK_InspectionStatus] PRIMARY KEY NONCLUSTERED ([Id]) ON [PRIMARY]
GO
