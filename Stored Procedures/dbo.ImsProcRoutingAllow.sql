...
-- Description:	Return allow in json format when user get an routing
-- InPut:		@Id = Routing.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcRoutingAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
