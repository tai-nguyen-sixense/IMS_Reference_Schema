...
-- Description:	Return allow in json format when user get an assetComponent
-- InPut:		@Id = AssetComponent.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcAssetComponentAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
