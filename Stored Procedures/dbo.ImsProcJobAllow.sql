...
-- Description:	Return allow in json format when user get an job
-- InPut:		@Id = Job.Id, @allowJson= default allow in json format, @UserId = Loggged User Id
...
CREATE PROCEDURE [dbo].[ImsProcJobAllow] @Id uniqueidentifier,@allowJson nvarchar(max), @UserId uniqueidentifier
